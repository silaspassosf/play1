...
def _verificar_quantidade_processos_paginacao(page: Page) -> int:
    """
...
def _ciclo1_aplicar_filtro_fases(page: Page) -> Union[bool, str]:
...
def _ciclo1_marcar_todas(page: Page) -> str:
...
def _ciclo1_abrir_suitcase(page: Page) -> bool:
...
def _ciclo1_aguardar_movimentacao_lote(page: Page) -> bool:
...
def _ciclo1_movimentar_destino_providencias(page: Page) -> bool:
...
def _ciclo1_movimentar_destino(page: Page, opcao_destino: str) -> bool:
...
def _ciclo1_retornar_lista(page: Page) -> None:
...
def _ciclo2_aplicar_filtros(page: Page) -> bool:
...
def _ciclo2_processar_livres(page: Page, client: Optional['PjeApiClient'] = None) -> int:
...
def _ciclo2_selecionar_nao_livres(page: Page, max_processos: int = 20) -> Tuple[int, bool]:
