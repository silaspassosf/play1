...
def _lazy_import_mandado_regras():
    ...
    if not _mandado_regras_modules_cache:
        ...
        from Fix.playwright_core import buscar_seletor_robusto, buscar_documento_argos
        ...
        from Fix.playwright_core import buscar_mandado_autor
...
def aplicar_regras_argos(
    ...
    Args:
        page: Page Selenium conectado a PJe
