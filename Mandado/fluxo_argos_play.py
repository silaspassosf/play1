...
from Fix.playwright_core import buscar_documento_argos
from Fix.playwright_core import buscar_documentos_sequenciais
...
def processar_argos(page: Page, log: bool = False) -> bool:
    """
